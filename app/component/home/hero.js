      ...
      <section className="hero flex flex-col-reverse md:flex-row items-center justify-between p-8 lg:p-16">
        <div className="hero-content md:text-left space-y-4 md:w-1/2">
          ...
          <div className="social-icons flex justify-center md:justify-start space-x-4">
            ...
            <div className="w-14 h-14 p-4 border-black border-2 rounded" aria-label="Reddit">
              {/* Reddit SVG */}
            ...
            <div className="w-14 h-14 p-4 border-black border-2 rounded" aria-label="Twitter">
              {/* Twitter SVG */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="w-14 h-14 p-4 border-black border-2 rounded" aria-label="Discord">
              {/* Discord SVG */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
